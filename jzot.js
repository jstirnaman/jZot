		...
		init : function( options ) { 
			...
			if(settings.userID || settings.groupID) {
				...
				if(settings.collectionKey) {
					var url = "https://api.zotero.org/" + library + "/collections/" + settings.collectionKey + "/items?v=" + settings.version + "&format=atom&content=json&itemType=" + settings.itemType + "&order=" + settings.order + "&limit=" + zoteroMaxResults + forceUpdate + "&key=" + settings.apiReadOnlyKey;
				} else {
					var url = "https://api.zotero.org/" + library + "/items?v=" + settings.version + "&format=atom&content=json&itemType=" + settings.itemType + "&order=" + settings.order + "&limit=" + zoteroMaxResults + forceUpdate + "&key=" + settings.apiReadOnlyKey;
				}
